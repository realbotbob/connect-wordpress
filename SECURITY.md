...
version, affected endpoint or admin action, and reproduction steps.

TROPIKAL Connect for WordPress is default-deny: no business object is exposed
until a WordPress administrator grants access.
